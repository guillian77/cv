        ...
        for($i=count($files)-1; $i >= 0; $i--):
            ...
            if($file_style == "block") { ?>
                <div class="fileDiv"
                    ...
                    <!-- AG EDIT FOR BETTER USER USE -->
                    <input type="text" style="border: none; background-color: transparent; margin-left: 15px;" value="<?php echo $image_url; ?>" id="myInput">
                    <button onclick="myFunction()" style="background-color: #2C3E50; color: #fafafa; padding: 8px; border: 1px solid #2C3E50; margin-left: 15px;">Copier l'URL</button>
                    ...
                    function myFunction() {
                      ...
                      alert("URL copié: " + copyText.value);
                    }
                    </script>
                </div>
