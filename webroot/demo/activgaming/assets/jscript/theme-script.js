...
(function ($) {
	...
	jQuery(document).ready(function() {
		...
		jQuery('.user-tooltip').hover(function() {
			...
			jQuery("#_strike-user").html('<a href="?page=user&action=profil&uid=10" class="username" style="background:#232323;color:#fff;">Jean-Michel Crapaud</a><a href="?page=user&action=profil&uid=10" class="avatar online"><span class="wrapimg" style="display:inline-block;position:relative;border-radius:inherit;-moz-border-radius:inherit;overflow:hidden;"><img src="assets/images/jean-michel_crapaud.jpg" alt="" width="90px" height="90px"/></span></a><div class="info"><div>"Me Balader dans la river ... ma passion"</div><div><font>Groupe:</font><span class="admin-ribbon">Carapateur</span></div><div><font>En train de:</font>Sa balader dans la river !</a>"</div></div><div class="clear-float"></div><div class="bottom"><a href="#" class="com-control"><i class="fa fa-envelope"></i>Message privé</a><a href="?page=user&action=profil&uid=10" class="com-control"><i class="fa fa-file-text-o"></i>Profil</a></div>');
...
// BEGIN EDITOR
		jQuery("a[href='#strike-bb']").click(function () {
			...
			switch(thisel.attr("class")){
				...
				case "strike-link":
					var weburl = prompt("Entrez une adresse de lien hypertexte","http://");
					if(weburl == null){
						break;
						return false;
					}
				...
				case "strike-photo":
					if(currenteditor == "wys-current"){
						var weburl = prompt("Entrez l'adresse de l'image","http://");
						if(weburl == null){
							break;
							return false;
						}
						...
						var weburl = prompt("Entrez l'adresse de l'image",extracted);
						if(weburl == null){
							extracted = (extracted == "http://") ? "" : extracted;
						...
						bbtext.replaceSelectedText("<img class='event-img' style='max-width:100%;' src='"+weburl+"'>");
					}
					break;
